This is a mirror of [openwrt/routing](https://github.com/openwrt-routing/packages) feed, so making PR there is the best way to contribute. New package will arrive to Entware-ng in the next month.
